...
pylab.gca().text(2,0.5,'Supercritical',ha='center',va='center')
...
pylab.plot(np.r_[1.4,1.4],np.r_[-y0,-y0+1],'k-.')
pylab.gca().text(0.65,-y0+0.5,'Supercritical\n liquid',ha='center',va='center')
pylab.gca().text(2.65,-y0+0.5,'Supercritical',ha='center',va='center')
...
pylab.gca().axis('off')
pylab.savefig('GasCoolerSections.pdf')
pylab.show()
pylab.close()