...
class CondenserClass():
    ...
    def _Supercritical_Forward(self,Tout_r_cr):
        ...
        self.h_r_supercritical, self.f_r_supercritical, cp_r, rho_supercritical = f_h_cp_supercritical(Tout_r_cr, self.Tin_r, self.AS, self.OD, self.ID,  self.mdot_r / self.Ncircuits, self.psat_r, self.Tin_a, self.Tcr);
