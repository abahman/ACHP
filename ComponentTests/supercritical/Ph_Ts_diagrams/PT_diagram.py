...
plt.plot(TT,PPnew,'darkblue',**melt_args)
...
plt.plot(Ts,ps/1000,'orange',lw = lw, solid_capstyle = 'round')
...
# Labels
plt.text(450, 1e8/1000, 'supercritical',ha= 'center')
plt.text(400, 2e6/1000, 'supercritical vapor', rotation = 0)
plt.text(275, 1e8/1000, 'supercritical liquid', rotation = 90, ha = 'center')
plt.text(235, 4.5e6/1000, 'liquid', rotation = 45)
plt.text(260, 1.5e6/1000, 'vapor', rotation = 45)
