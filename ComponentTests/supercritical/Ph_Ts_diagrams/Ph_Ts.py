...
plt.text(1.2,100,'Supercritical',ha='center',va='top')
...
plt.text(0.62,40,'$T=T_{cr}$',ha='center',va='top')
leg=plt.legend(loc='upper left',fancybox=False, numpoints=1)
frame=leg.get_frame()  
frame.set_linewidth(1.0)
plt.tight_layout() 
ts_plot_R744.savefig('Ts_case2.pdf')    
ts_plot_R744.show()
