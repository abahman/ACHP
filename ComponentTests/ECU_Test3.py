...
#     Write2CSV(cycle,open('Cycle.csv','a'),append=True)
    ...
    P_exp = [486.9,2333.0,2333.0,2324.0,2324.0,735.3,486.9,486.9,486.9] #in kPa 
    P_exp = numpy.array(P_exp)
    P_exp *= 1000.0 #convert kPa to Pa
    T_exp = [12.92+273.15, 98.88+273.15, PropsSI('T','P',P_exp[2],'Q',1,ref_fluid), PropsSI('T','P',P_exp[3],'Q',0,ref_fluid), 46.74+273.15, 9.853+273.15, PropsSI('T','P',P_exp[6],'Q',1,ref_fluid), 10.97+273.15, 12.92+273.15] #in Kelvin    
