...
if __name__=='__main__':
    ...
    #Write2CSV(cycle5,open('results/Cycle_60K_Test1_VICompTello_new2.csv','w'),append=False)
    Write2CSV(cycle5,open('results/Cycle_60K_Test1_VICompTello_new2.csv','a'),append=True)
