...
def ECUCycle_VICompTello():
    ...
    #Dimensioless compressor map
    if Cycle.Ref=='R407C':
        #Domenqiue's Data 2 (more accurate)
        K=[-0.5912,0.5134]
        M=[61.56269036,-0.734001988177,-0.295637215677,-0.00414491132672,0.03327506972,-0.00158321159284,0.000185442285694,-2.066300599E-05,-0.0001411773158,1.50399464873E-05]
        P=[1.075,1.728,3.915,1.061,-1.127,0.3856,-0.001918,-0.007111,0.007511,-0.001704,33.81]
        #Domenique's Data
#         K=[- 0.2312,0.259]
