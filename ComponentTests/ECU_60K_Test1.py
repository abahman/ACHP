...
#from CoolProp.Plots import PropsPlot, Ts, drawIsoLines
...
def ECUCycle():
    ...
    Cycle.Condenser.Fins.Air.Vdot_ha=cfm2cms(3800)     #Air volume flow rate in m^3/s
...
if __name__=='__main__':
    ...
    Write2CSV(cycle,open('results/Cycle_60K_Test1.csv','w'),append=False)
...
#     fig.savefig('images/60K/comined_R407C_60K_Test1.pdf')
#     props_plot.show()