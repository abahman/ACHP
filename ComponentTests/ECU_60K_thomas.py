...
def ECUCycle():
    ...
    Cycle.Condenser.Fins.Air.Vdot_ha=cfm2cms(3800)     #Air volume flow rate in m^3/s (((Reducing the flow rate from 1600cfm to 1300cfm)
    ...
    Cycle.Condenser.Fins.Air.FanPower=1120              #Fan power, Watts
...
if __name__=='__main__':
    ...
    Write2CSV(cycle,open('results/Cycle_60K_Thomas.csv','w'),append=False)
...
#     Write2CSV(cycle,open('Cycle.csv','a'),append=True)
    ...
    #P_exp = [655.8,3108.0,3108.0,3095.0,3095.0,877.8,655.8,655.8,655.8,655.8] #in kPa 
    #P_exp = numpy.array(P_exp)
    #P_exp *= 1000.0 #convert kPa to Pa
    #T_exp = [17.92+273.15, 111.0+273.15, PropsSI('T','P',P_exp[2],'Q',1,ref_fluid), PropsSI('T','P',P_exp[3],'Q',0,ref_fluid), 60.57+273.15, 16.25+273.15,0+273.15,PropsSI('T','P',P_exp[6],'Q',1,ref_fluid), 16.59+273.15, 17.92+273.15] #in Kelvin    
...
#     ts_plot_R407C.show()
    ...
    fig.savefig('images/comined_R407C_60K_Thomas.pdf')
    props_plot.show()