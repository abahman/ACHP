...
def ECUCycle():
    ...
    params={
            ...
            'fp':0.04, #Fraction of electrical power lost as heat to ambient 
    ...
    Cycle.Condenser.Fins.Air.Vdot_ha=cfm2cms(1230)     #Air volume flow rate in m^3/s (((Reducing the flow rate from 1600cfm to 1300cfm)
    ...
    Cycle.Evaporator.Fins.Air.Vdot_ha=cfm2cms(290)          #reducing the flow rate from 600cfm to 300cfm
