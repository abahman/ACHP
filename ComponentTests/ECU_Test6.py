...
def ECUCycle():
    ...
    Cycle.Condenser.Fins.Air.FanPower=670.2              #Fan power, Watts
    ...
    Cycle.Evaporator.Fins.Air.FanPower=401.9
...
if __name__=='__main__':
    ...
    Write2CSV(cycle,open('results/Cycle_Test#6.csv','w'),append=False)
    #Write2CSV(cycle,open('results/Cycle_Test#6','a'),append=True)
...
#     Write2CSV(cycle,open('Cycle.csv','a'),append=True)
    ...
    P_exp = [423.4,1639.0,1639.0,1624.0,1624.0,637.3,423.4,423.4,423.4,423.4] #in kPa 
    P_exp = numpy.array(P_exp)
    P_exp *= 1000.0 #convert kPa to Pa
    T_exp = [7.556+273.15, 73.63+273.15, PropsSI('T','P',P_exp[2],'Q',1,ref_fluid), PropsSI('T','P',P_exp[3],'Q',0,ref_fluid), 32.18+273.15, 4.761+273.15,0+273.15, PropsSI('T','P',P_exp[6],'Q',1,ref_fluid), 6.396+273.15, 7.556+273.15] #in Kelvin    
...
#     ph_plot_R407C.savefig('images/R407C_Ph_Test6.pdf')    
#     ph_plot_R407C.show()
#      
#     #Plot T-s diagram  
...
#     plt.legend(loc='best',fancybox=False)
#     ts_plot_R407C.savefig('images/R407C_Ts_Test6.pdf')    
#     ts_plot_R407C.show()
    ...
    fig.savefig('images/comined_R407C_Test6.pdf')
    props_plot.show()