...
def ECUCycle():
    ...
    params={
            ...
            'fp':0.09, #Fraction of electrical power lost as heat to ambient 
    ...
    Cycle.Condenser.Fins.Air.Vdot_ha=cfm2cms(1290)     #Air volume flow rate in m^3/s
...
#     Write2CSV(cycle,open('Cycle.csv','a'),append=True)
    ...
    P_exp = [502.9,2135.0,2135.0,2124.0,2124.0,758.8,502.9,502.9,502.9,502.9] #in kPa 
    P_exp = numpy.array(P_exp)
    P_exp *= 1000.0 #convert kPa to Pa
    T_exp = [12.58+273.15,87.93+273.15,PropsSI('T','P',P_exp[2],'Q',1,ref_fluid), PropsSI('T','P',P_exp[3],'Q',0,ref_fluid),43.52+273.15, 10.7+273.15,0+273.15,PropsSI('T','P',P_exp[6],'Q',1,ref_fluid), 11.53+273.15, 12.58+273.15] #in Kelvin
    ...
    s_exp = [PropsSI('S','P',P_exp[0],'T',T_exp[0],ref_fluid), PropsSI('S','P',P_exp[1],'T',T_exp[1],ref_fluid), 
             ...
             PropsSI('S','P',P_exp[7],'Q',1,ref_fluid), PropsSI('S','P',P_exp[9],'T',T_exp[8],ref_fluid), 
...
#     ph_plot_R407C.savefig('images/R407C_Ph_Test4.pdf')    
#     ph_plot_R407C.show()
#      
#     #Plot T-s diagram  
...
#     plt.legend(loc='best',fancybox=False)
#     ts_plot_R407C.savefig('images/R407C_Ts_Test4.pdf')    
#     ts_plot_R407C.show()
    ...
    fig.savefig('images/comined_R407C_Test4.pdf')
    props_plot.show()