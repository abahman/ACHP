...
def ECUCycle():
    ...
    Cycle.Condenser.Fins.Air.FanPower=668.2              #Fan power, Watts
    ...
    Cycle.Evaporator.Fins.Air.FanPower=405.5
...
if __name__=='__main__':
    ...
    Write2CSV(cycle,open('results/Cycle_Test#5.csv','w'),append=False)
    #Write2CSV(cycle,open('results/Cycle_Test#5','a'),append=True)
...
#     Write2CSV(cycle,open('Cycle.csv','a'),append=True)
    ...
    P_exp = [407.7,1843.0,1843.0,1833.0,1833.0,627.5,407.7,407.7,407.7,407.7] #in kPa 
    P_exp = numpy.array(P_exp)
    P_exp *= 1000.0 #convert kPa to Pa
    T_exp = [8.574+273.15, 85.15+273.15, PropsSI('T','P',P_exp[2],'Q',1,ref_fluid), PropsSI('T','P',P_exp[3],'Q',0,ref_fluid), 36.29+273.15, 4.47+273.15,0+273.15, PropsSI('T','P',P_exp[6],'Q',1,ref_fluid), 7.187+273.15, 8.574+273.15] #in Kelvin    
...
#     ph_plot_R407C.savefig('images/R407C_Ph_Test5.pdf')    
#     ph_plot_R407C.show()
#      
#     #Plot T-s diagram  
...
#     plt.legend(loc='best',fancybox=False)
#     ts_plot_R407C.savefig('images/R407C_Ts_Test5.pdf')    
#     ts_plot_R407C.show()
    ...
    fig.savefig('images/comined_R407C_Test5.pdf')
    props_plot.show()