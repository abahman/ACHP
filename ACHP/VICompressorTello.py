...
class VICompressorTelloClass():
    ...
    def Calculate(self):
        ...
        mdot_map /= 1000.0 
        #mdot_r=+133.3171898+0.508718380832*te_f-2.15889885692*tc_f+0.00847246179835*te_f**2+0.009495493298*te_f*tc_f+0.0170835511659*tc_f**2+3.65431994895e-05*te_f**3+6.660136064e-06*te_f**2*tc_f-4.719716435e-05*te_f*tc_f**2-4.61719969253e-05*tc_f**3        # Convert mass flow rate to kg/s from lbm/h
